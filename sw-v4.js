const CACHE_NAME="sbs-hq-v5-photo-link";
const ASSETS=["./","./index.html","./styles-v6.css?v=real-header-fix","./app-v6.js?v=photo-link-fix","./manifest.json","./spaceboi-logo.png"];
