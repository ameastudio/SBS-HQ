const CACHE_NAME="sbs-hq-v10-delete-booking";
const ASSETS=["./","./index.html","./styles-v6.css?v=real-header-fix","./app-v10.js?v=delete-booking","./manifest.json","./spaceboi-logo.png"];
